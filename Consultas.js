...
db.Paciente.find( { email(s): { $exists: false } }, { _id: 0, nome: 1, cpf: 1 } )
...
db.Medico.find( { nome: /Adam/, "email(s).0": { $exists: true } }, { _id: 0, nome: 1, crm: 1} )


// (01) Consulta com acesso a array:

// Nome e telefone de todos os Médicos:
db.Medico.find( { }, { _id: 0, nome: 1, telefone(s): 1 } )
